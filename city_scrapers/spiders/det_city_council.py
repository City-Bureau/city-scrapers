...
class DetCityCouncilSpider(Spider):
    ...
    def _next_month(response):
        ...
        if prev_call_count < 12:
            form_params_xpath = "//td[@class='EventNextPrev'][1]/a/@href"
    ...
    def _generate_requests(self, response):
        anchor_xpath = '//table[@id="dnn_ctr8319_Events_EventMonth_EventCalendar"]//a[contains(@id, "ctlEvents")][not(contains(., "Recess"))]'
    ...
    def _parse_name(response):
        name_xpath = '//div[@id="dnn_ctr8319_EventDetails_divEventDetails1"]//span[contains(@class, "Head")]/text()'
