...
class ChiIlMedicalDistrictSpider(CityScrapersSpider):
    ...
    def parse(self, response):
        ...
        needs.
        """
        # Generate the mapping of dates and links as well as a list of upcoming datetimes
        ...
        # Create a list of all the unique dates found including any relevant times (with defaults)
