data = {
  ...
  'status': 'tentative',      # required string, one of the following: 'cancelled': event is listed as cancelled or rescheduled 'tentative': event both does not have an agenda and the event is > 7 days away
