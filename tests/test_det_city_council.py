...
test_detail = file_response(
    ...
    'http://www.detroitmi.gov/Government/City-Council/City-Council-Sessions/ModuleID/8319/ItemID/6556/mctl/EventDetails'  # noqa
)
...
def test_start():
    assert parsed_items[0]['start'] == {'date': date(2018, 7, 5), 'time': time(10, 00), 'note': ''}
...
def test_documents():
    assert parsed_items[0]['documents'] == [{
        'url':
            "http://www.detroitmi.gov/Portals/0/docs/City Clerk/Council 2018/Planning Economic/CAL 07-5-18 PED.pdf?ver=2018-07-03-164858-537",  # noqa
