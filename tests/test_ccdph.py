...
test_response = file_response('files/ccdph_321.html', 'http://www.cookcountypublichealth.org/events-view/321')
spider = CcdphSpider()
...
def test_start_time():
    assert item['start_time'] == '2017-09-08T10:00:00-05:00'


def test_end_time():
    assert item['end_time'] == '2017-09-08T14:00:00-05:00'
