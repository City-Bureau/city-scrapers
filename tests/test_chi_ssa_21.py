...
def test_description():
    assert parsed_items[0]['event_description'] == '2018 Meetings Calendar[Review and Approval]:2018 Budget Adjustments[(if applicable)]:Strategic Planning[with PLACE Consulting]'
...
def test_documents():
    assert parsed_items[0]['documents'] == [{
        'note': 'Meeting notes',
        'url': 'https://chambermaster.blob.core.windows.net/userfiles/UserFiles/chambers/697/CMS/SSA_2018/SSA21_MeetingMinutes_1.29.18.pdf'
    }]
