...
def test_name():
    assert parsed_items[0]['name'] == 'Detroit Entertainment Commission'
...
def test_id():
    assert parsed_items[0]['id'] == 'det_entertainment_commission/201807161700/x/detroit_entertainment_commission'
