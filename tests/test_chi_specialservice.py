...
from city_scrapers.spiders.chi_specialservice import ChiSpecialserviceSpider

test_response = file_response(
    join(dirname(__file__), "files", "chi_specialservice.html"),
    url="https://www.mpbhba.org/business-resources/",
)
spider = ChiSpecialserviceSpider()
