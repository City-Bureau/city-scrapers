...
def test_source(parsed_items):
    assert parsed_items[0]["source"] == "https://nwheap.com/events/governing-commissioners-public-meeting-18/"

def test_time_notes(parsed_items):
    assert parsed_items[0]["time_notes"] == ""

def test_id(parsed_items):
    assert parsed_items[0]["id"] == "chi_northwest_home_equity/202310191830/x/governing_commissioners_public_meeting"
