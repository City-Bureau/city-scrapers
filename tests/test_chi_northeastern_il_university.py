...
def test_title():
    ...
    assert (
        parsed_items[1]["title"] == "FINANCE, BUILDINGS AND GROUNDS COMMITTEE MEETING"
    )
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "chi_northeastern_il_university/202409191300/x/board_meeting"
    )
...
def test_links():
    assert parsed_items[0]["links"] == [
        ...
        {"href": "https://youtu.be/8PLfgYgandQ", "title": "Meeting Video"},
    ]
